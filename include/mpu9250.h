...
float _magCalFactory[3] = {0, 0, 0};  // Factory mag calibration and mag bias
float _gyroBias[3] = {0, 0, 0}, _accelBias[3] = {0, 0, 0}, _magBias[3] = {0, 0, 0}, _magScale[3]  = {0, 0, 0};      // Bias corrections for gyro and accelerometer
//int16_t _tempCount;            // temperature raw count output
//float   _temperature;          // Stores the MPU9250 gyro internal chip temperature in degrees Celsius
...
uint8_t _Gscale, _Ascale, _Mscale, _Mmode;
